...
namespace Nop.Plugin.Widgets.MySlider.Models
{
    public record ConfigurationModel : BaseNopModel
    {
        ...
        [NopResourceDisplayName("Plugins.Widgets.MySlider.Picture")]
        [UIHint("Picture")]
        public int Picture1Id { get; set; }
        public bool Picture1Id_OverrideForStore { get; set; }
        [NopResourceDisplayName("Plugins.Widgets.MySlider.Text")]
        public string Text1 { get; set; }
        public bool Text1_OverrideForStore { get; set; }
        [NopResourceDisplayName("Plugins.Widgets.MySlider.Link")]
        public string Link1 { get; set; }
        public bool Link1_OverrideForStore { get; set; }
        [NopResourceDisplayName("Plugins.Widgets.MySlider.AltText")]
